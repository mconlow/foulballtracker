...
**/
include '/home/wwhitehead/foulballtracker.com/clickheat/classes/Heatmap.class.php';
include '/home/wwhitehead/foulballtracker.com/clickheat/classes/HeatmapFromDatabase.class.php';
...
**/
$heatmap->host = 'ballparks.mikeconlow.com';
$heatmap->query = 'SELECT test, test2 FROM clicks where ballpark_id = 1';
$heatmap->maxQuery = 'SELECT MAX(test2) FROM clicks where ballpark_id = 1';
$heatmap->database = 'ballparks_clicks';
...
**/
$images = $heatmap->generate(600, 634);
if ($images === false)
{
...
else
{
	...
	echo '<div style="position: relative;"><img src="/images/image293.gif" style="position: absolute; z-index: 999;" />';
