...
$heatmap->query = 'SELECT test, test2 FROM clicks where ballpark_id = 2';
$heatmap->maxQuery = 'SELECT MAX(test2) FROM clicks where ballpark_id = 2';
...
**/
$images = $heatmap->generate(581, 560);
if ($images === false)
{
...
else
{
	...
	echo '<div style="position: relative;"><img src="/images/was_park.png" style="position: absolute; z-index: 999;" />';
