...
>
  ...
  <tr>
      <td bgcolor="#c0c0c0">
      <p align="center">&nbsp; <a 
      href="http://foulballtracker.com/index_test.php?ballpark_id=1"><img height="50" 
      alt=Philadelphia hspace=0 src="images/phl.gif" width=75 border=0></a><a 
      href="http://foulballtracker.com/index_test.php?ballpark_id=2"><img 
...
//Retrieve data from Query Strin
...
$arr = array(1=>"Citizens Bank Park", 2=>"Nationals Park");
$abbreviation = array(1=>"phl", 2=>"was");

echo '<p align="left"><a class="navblack" href="http://foulballtracker.com/',$abbreviation[$ballpark_id],'.htm"><font size="3">Enter foul ball locations for ',$arr[$ballpark_id],'</font></a></p>
<h2 align="left">This is the foul ball heat map for ',$arr[$ballpark_id],':</h2>';
